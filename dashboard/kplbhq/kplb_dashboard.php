...
$villagerreportresult = mysqli_query($db, $sql);
...
$penghulureportresult = mysqli_query($db, $sql);
...
$sql = "
    ...
    ORDER BY r.created_at DESC
";
$ketuareportresult = mysqli_query($db, $sql);
...
$sql = "
    ...
    ORDER BY r.created_at DESC
";
$pejabatdaerahresult = mysqli_query($db, $sql);
